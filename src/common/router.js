...
export const getRouterData = app => {
  const routerConfig = {
    ...
    '/store/home': {
      component: dynamicWrapper(app, [], () => import('../routes/Store/Home'))
    },
    '/store/storelist': {
      component: dynamicWrapper(app, [], () => import('../routes/Store/StoreList'))
    },
    '/store/detail': {
      component: dynamicWrapper(app, [], () => import('../routes/Store/Detail'))
    },
    '/dashboard/analysis': {
    ...
    '/dashboard/workplace': {
      ...
      // hideInBreadcrumb: true, name: '工作台', authority: 'admin',
    },
    '/form/basic-form': {
  ...
  Object
    ...
    .forEach(path => {
      ...
      // nav.md#%E5%B8%A6%E5%8F%82%E6%95%B0%E7%9A%84%E8%B7%AF%E7%94%B1%E8%8F%9C%E5%8D%9
      // 5 eg . /list/:type/user/info/:id
      router = {
        ...router,
